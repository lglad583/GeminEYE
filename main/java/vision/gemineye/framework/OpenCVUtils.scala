...
object OpenCVUtils {
  ...
  /** Convert native trackedPoints to JVM array.
    *
    * @param keyPoints pointer to a native trackedPoints containing KeyPoints.
    */
  ...
  /** Convert native trackedPoints to JVM array.
    *
    * @param matches pointer to a native trackedPoints containing DMatches.
    * @return
    */
  ...
  def toMatPoint2f(points: Seq[Point2f]): Mat = {
    // Create Mat representing a trackedPoints of Points3f
  ...
  /**
   * Convert a sequence of Point3D to a Mat representing a trackedPoints of Points3f.
   * Calling  `checkVector(3)` on the return value will return non-negative value indicating that it is a trackedPoints with 3 channels.
   */
  ...
  def toPoint2fArray(mat: Mat): Array[Point2f] = {
    require(mat.checkVector(2) >= 0, "Expecting a trackedPoints Mat")
  ...
  /**
   * Convert a trackedPoints of Point2f to a Mat representing a trackedPoints of Points2f.
   */
  ...
  /** Convert a Scala collection to a JavaCV "trackedPoints".
    *
